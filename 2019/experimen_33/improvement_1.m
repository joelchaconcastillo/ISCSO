function [feval, original, f_original, w_original, s_original, d_original ] = improvement_1(original_in, f_original_in, w_original_in, s_original_in, d_original_in, stress_penalization, displacement_penalization, NSizing_variables, NShape_variables, lower, upper, feval_in, dim, maxite)
          ...
          f_original
              while current(i)-jump >= lower(i) 
               ...
               if f_current< f_original
                   ...
                   save('history_improvement_1_2', 'row_v', '-ascii', '-append');
