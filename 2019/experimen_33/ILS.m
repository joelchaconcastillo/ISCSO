...
%   [feval, current, f, w, s, d ] = improvement_2(current, f, w, s, d, stress_penalization, displacement_penalization, NSizing_variables, NShape_variables, lower, upper, feval, dim, 1000);
   [feval, current, f, w, s, d ] = improvement_3(current, f, w, s, d, stress_penalization, displacement_penalization, NSizing_variables, NShape_variables, lower, upper, feval, dim, maxIteNoUpdate);
   [feval, current, f, w, s, d] = improvement_1(current, f, w, s, d, stress_penalization, displacement_penalization, NSizing_variables, NShape_variables, lower, upper, feval, dim, 10);
